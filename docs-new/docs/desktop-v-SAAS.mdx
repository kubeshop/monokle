...
Monokle Desktop also has the capability to **_Preview Shell Commands_**.
...
Plans for future checking functionalities in both Desktop and Cloud include: **_Results of other policies (Kyberno)_** and **_Define your own policies_**.

### **Compare Resources**

Monokle has robust compare features for almost any resource. Compare **_Files, Folders, Helm Output, Kustomize Output, Configurations, Git Branches_** and **_Commits_** with both Desktop and Cloud.

With Desktop, compare **_Configurations, Clusters_** and **_Shell Command Output_**.
...
Collaborate on **_Personal Shareable Policies_** with both versions of Monokle.
...
In Monokle Desktop you can also **_Modify local files_** and **_Clusters_**.
