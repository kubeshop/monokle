...
import {K8sResource, RefPosition, ResourceValidationError} from '@shared/models/k8sResource';
import {POLICY_VALIDATOR_MAP, Policy, SarifRule} from '@shared/models/policy';
...
function isManagedByKustomize(resource: K8sResource): boolean {
