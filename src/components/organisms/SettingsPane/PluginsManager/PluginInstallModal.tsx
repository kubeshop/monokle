...
import {DOWNLOAD_PLUGIN, DOWNLOAD_PLUGIN_RESULT} from '@shared/constants/ipcEvents';
import {DownloadPluginResult, isDownloadPluginResult} from '@shared/models/extension';
