...
const MonokleHackathon: React.FC = () => {
  ...
  const onPreviewHandler = async () => {
    ...
    try {
      const message = `You will create just k8s manifest based on the following needs. The manifest should be between code blocks. use separate code blocks. Needs: ${inputValue}.`;
