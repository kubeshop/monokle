...
function UnknownResourceNameDisplay() {
  ...
  const unknownResourceCount = useAppSelector(state => unknownResourcesSelector(state).length);

  if (isInClusterMode) {
    return (
      <S.ClusterOutputTag $kubeConfigContextColor={kubeConfigContextColor}>
        <S.Bold>{unknownResourceCount} unknown resources</S.Bold> found in <S.Bold>{currentContext}</S.Bold>
      </S.ClusterOutputTag>
    );
  }
  ...
  if (isInPreviewMode) {
    return (
      <S.PreviewOutputTag>
        <S.Bold>{unknownResourceCount} unknown resources</S.Bold> generated by the{' '}
        <S.Bold>{previewType} preview</S.Bold>
      </S.PreviewOutputTag>
    );
  }
  ...
  return (
    <S.LocalOutputTag>
      <S.Bold>{unknownResourceCount} unknown resources</S.Bold> found in your <S.Bold>files</S.Bold>
    </S.LocalOutputTag>
  );
}

export default UnknownResourceNameDisplay;
